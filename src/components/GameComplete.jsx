  ...
  return(
    <div className='GameComplete' >
      ...
      <div className='row victory-share'>
        <a className='social-share' href={`//twitter.com/share?text=${encodeURIComponent(`I just beat #Chromattis Level ${''} in ${''} ${''}. I bet you can't do it in fewer!\n\nPlay for free here:\n`)}`} target='_blank' rel='noreferrer'><img src={`${process.env.PUBLIC_URL}/x.png`} alt='Post on X'/></a>
        <a className='social-share' href='//facebook.com/sharer/sharer.php?u=https%3A%2F%2Fcaptainstack.github.io%2Fchromattis%2F&amp;src=sdkpreparse' target='_blank' rel='noreferrer'><img src={`${process.env.PUBLIC_URL}/facebook.png`} alt='Share on Facebook' target='_blank' rel='noreferrer'/></a>
