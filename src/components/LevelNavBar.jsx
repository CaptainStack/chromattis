...
export const LevelNavBar = ({levels, current_level_index, highest_unlocked_level, hide_tooltips}) => {
  ...
  return(<div className='LevelNavBar row' title={hide_tooltips ? null : 'Open level select menu'}><strong onClick={toggleLevelNavMenu}>SELECT LEVEL</strong>{buttons}</div>);
}
