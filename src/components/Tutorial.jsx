...
export const Tutorial = ({show_tutorial, tutorial}) => {
  ...
  return(
    <div className='Tutorial' style={{ display: show_tutorial ? null : 'none' }}>
      ...
      <strong>LESSON {tutorial.current_level_index} of {tutorial.levels.length - 1} - {lesson.text}</strong>
      <div className='row' style={{marginTop:'8px'}}>
        ...
        <span className='flat-button' onClick={tutorialButtonClicked}><span>Back to game ↩</span></span>
